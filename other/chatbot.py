...
nama = ["nama saya FelIca, F E L I C A"]
kenalan = ["Ayok, namamu siapa ?"]
kenalan2 = ["boleh kok hehe"]
asal = ["saya berasal dari kumpulan berbagai macam bahasa pemrograman, Contohnya program chat ini basisnya python", "lah kepo.."]
cipta = ["saya dibuat oleh ivan:)"]
tempat_tinggal = ["Kalau berdasarkan lokasi server saya, saya mungkin berasal dari jepang. hehehe konnichiwa","Saya tinggal di jepang, karena server saya ada di Jepang:v. ivan ngonsol, kenapa ga beli server singapura aja sih. dia wibu"]
